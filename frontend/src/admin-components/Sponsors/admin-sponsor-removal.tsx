        ...
        <div className="flex flex-col items-center h-full justify-center px-6 py-8 mx-auto lg:py-0">
          <div className="w-full rounded-lg shadow border md:mt-0 sm:max-w-2xl xl:p-0 bg-gray-800 border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 className="text-xl font-bold leading-tight tracking-tight text-creame md:text-2x">
                Delete Sponsor
              </h1>
              <select
                value={selectedSponsor}
                onChange={handleSponsorChange}
                className=" border text-creame rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-40 focus:ring-blue-500 focus:border-blue-500"
              >
          ...
          <div className= "rounded-lg shadow-lg p-8">
            ...
            <div className="flex justify-between">
              <button
                ...
                className="bg-red-60 px-4 py-2 rounded-lg"
              >
                Yes
              </button>
              <button
